...
ICONS="account_tree,add,android,arrow_downward,arrow_upward,bookmark,check_circle,chevron_left,chevron_right,close,cloud_upload,code,content_copy,content_cut,content_paste,create_new_folder,dark_mode,data_object,delete,description,desktop_windows,disc_full,download,draft,drive_folder_upload,edit,error,expand_more,folder,folder_open,folder_zip,font_download,home,hourglass_empty,image,inventory_2,light_mode,menu,more_vert,movie,music_note,navigate_before,navigate_next,open_in_new,phone_iphone,picture_as_pdf,radio_button_unchecked,refresh,search,settings,share,slideshow,swap_vert,sync,table_chart,terminal,unfold_more,upload,visibility"
